import numpy as np
from core.ultility.readDataFile import load_txt_dataset
from core.algorithm.kmeans import Kmeans
import math
import random
from core.ultility.utilities import round_float, write_excel_file, distance_cdist
import os
import time
